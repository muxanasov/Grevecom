...
public class AdaptiveIllegalSpecimen extends Specimen{
	
	@Override
	public String sayHello(){
		String cx = _dcx?"out":"";
		return "Adaptive Illegal time with"+cx+" counterexample generation.";
	}
	...
	public Object update(int groups, int contexts_per_group) {
		...
		gossip.setTriggers(ppg.getName().replaceAll(" ", "")+"."+link.getName().replaceAll(" ", ""));

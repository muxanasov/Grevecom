...
public class WildlifeUserSpecimen extends Specimen{
	
	@Override
	public String sayHello(){
		String cx = _dcx?"out":"";
		return "Wildlife User time with"+cx+" counterexample generation.";
	}
	
	@Override
	public boolean resultIsCorrect(){
		return _result.contains("AG !(ActivityGroup.Running & HealthConditionsGroup.Diseased)  is true");
	}
	...
	public Object update(int groups, int contexts_per_group) {
		...
		unreachable.setTriggers("ActivityGroup.Moving");

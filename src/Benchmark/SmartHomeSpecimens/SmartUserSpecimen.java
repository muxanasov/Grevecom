...
public class SmartUserSpecimen extends Specimen{
	
	@Override
	public String sayHello(){
		String cx = _dcx?"out":"";
		return "Smart User time with"+cx+" counterexample generation.";
	}
	
	@Override
	public boolean resultIsCorrect(){
		return _result.contains("AG !(EmergencyGroup.Fire & TemperatureGroup.Low)  is false");
	}
	
	@Override
	public void throwException() throws Exception{
		throw new Exception("The model is not ferifyable!\n"+_result);
	}
	...
	public Object update(int groups, int contexts_per_group) {
		...
		new Connection(t_normal, "cold iff Night", low);

...
public class AdaptiveDeadlockSpecimen extends Specimen{
	
	@Override
	public String sayHello(){
		String cx = _dcx?"out":"";
		return "Adaptive Deadlock time with"+cx+" counterexample generation.";
	}
	...
	public Object update(int groups, int contexts_per_group) {
		...
		new Connection(gossip, "static iff Lifetime", ctp);

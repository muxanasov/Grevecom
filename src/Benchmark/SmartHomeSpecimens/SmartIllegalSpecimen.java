...
public class SmartIllegalSpecimen extends Specimen{
	
	@Override
	public String sayHello(){
		String cx = _dcx?"out":"";
		return "Smart Illegal time with"+cx+" counterexample generation.";
	}
	...
	public Object update(int groups, int contexts_per_group) {
		...
		bright.setTriggers(pg.getName().replaceAll(" ", "")+"."+day.getName().replaceAll(" ", ""));

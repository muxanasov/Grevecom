...
/**
 * Create new new .shape-file. Those files can be used with the ConesCEditor
 * (see plugin.xml).
 * 
 * @author Elias Volanakis
 */
public class ConesCCreationWizard extends Wizard implements INewWizard {
	...
	/**
	 * This WizardPage can create an empty .shapes file for the ConesCEditor.
	 */
	private class CreationPage extends WizardNewFileCreationPage {
		private static final String DEFAULT_EXTENSION = ".cgd";
		 ...
		 * @see ConesCCreationWizard#init(IWorkbench, IStructuredSelection)
		 */
		...
		public void createControl(Composite parent) {
			...
			setFileName("Diagram" + fileCount + DEFAULT_EXTENSION);
		 ...
		 * 
		 * @see ConesCCreationWizard#performFinish()
		 */
		boolean finish() {

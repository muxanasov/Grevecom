...
public class IllegalTransitionsSpecimen extends Specimen {

	@Override
	public String sayHello(){
		String cx = _dcx?"out":"";
		return "Illegal Transition time with"+cx+" counterexample generation.";
	}
	...
	public Object update(int groups, int contexts_per_group) {
		...
		diagram = BenchmarkUtils.putIllegalTransition(diagram);

 ...
 * </ol>
 * 
 * @see org.eclipse.conesc.plugin.parts.ShapeEditPart#createEditPolicies() for
 *      an example of the above procedure.
...
public class ConnectionReconnectCommand extends Command {
	...
	private Context newSource;
	/** The new target endpoint. */
	private Context newTarget;
	/** The original source endpoint. */
	private final Context oldSource;
	/** The original target endpoint. */
	private final Context oldTarget;
	 ...
	 */
	public void setNewSource(Context connectionSource) {
	 ...
	 */
	public void setNewTarget(Context connectionTarget) {

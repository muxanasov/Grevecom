...
public class UserUnSpecsSpecimen extends Specimen{
	...
	public String sayHello(){
		String cx = _dcx?"out":"";
		return "User-defined unsatisfied specifications time with"+cx+" counterexample generation.";
	}
	...
	public void throwException() throws Exception {
		throw new Exception("Model is verifyable!\n"+_result);
	}
	
	@Override
	public Object init(Object[] args) {
		_specs_list.add("AG (EF (Day&Night));");
		_specs_list.add("AG (EF (Day&Weekend));");
		_specs_list.add("AG (EF (Night&Weekend));");
		_specs_list.add("AG (EF (Normal&Fire));");
		_specs_list.add("AG (EF (Normal&Housebreaking));");
		_specs_list.add("AG (EF (Fire&Housebreaking));");
		_specs_list.add("AG (EF (Dark&Bright));");
		_specs_list.add("AG !(Day&Normal);");
		_specs_list.add("AG !(Day&Fire);");
		_specs_list.add("AG !(Day&Housebreaking);");
		_specs_list.add("AG !(Night&Normal);");

...
public class WildlifeDeadlockSpecimen extends Specimen{
	
	@Override
	public String sayHello(){
		String cx = _dcx?"out":"";
		return "Wildlife Deadlock time with"+cx+" counterexample generation.";
	}
	...
	public Object update(int groups, int contexts_per_group) {
		...
		d2h.setLabel("normal body temperature iff Running");

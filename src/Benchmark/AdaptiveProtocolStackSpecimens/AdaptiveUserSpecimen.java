...
public class AdaptiveUserSpecimen extends Specimen{
	
	@Override
	public String sayHello(){
		String cx = _dcx?"out":"";
		return "Adaptive User time with"+cx+" counterexample generation.";
	}
	
	@Override
	public boolean resultIsCorrect(){
		return _result.contains("AG ProtocolParametersGroup.Lifetime  is false");
	}
	...
	public Object update(int groups, int contexts_per_group) {
		...
		//new Connection(bandwidth, "low link quality", link);

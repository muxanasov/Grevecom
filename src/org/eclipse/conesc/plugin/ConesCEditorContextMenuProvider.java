...
/**
 * Provides context menu actions for the ConesCEditor.
 * 
 * @author Elias Volanakis
 */
class ConesCEditorContextMenuProvider extends ContextMenuProvider {
	 ...
	 */
	public ConesCEditorContextMenuProvider(EditPartViewer viewer,
	...
	public void buildContextMenu(IMenuManager menu) {
		...
		menu.appendToGroup(GEFActionConstants.GROUP_EDIT,
				getAction(ActionFactory.EDIT_ACTION_SETS.getId()));
		menu.appendToGroup(GEFActionConstants.GROUP_PRINT,
				getAction(ActionFactory.EXPORT.getId()));
		menu.appendToGroup(GEFActionConstants.GROUP_PRINT,
